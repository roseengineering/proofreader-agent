...
http://127.0.0.1:8081).  (There is also an extension for Chrome, but its
"async" protocol is a bit different so it is not supported yet. Pages and Word do no longer support, I think, custom LanguageTool servers.)
